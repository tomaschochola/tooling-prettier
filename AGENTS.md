...
Shared Prettier configuration builder and scaffolds for JavaScript and TypeScript projects.
...
- Runtime: Node 24
- OS: GNU/Linux
- Libraries: prettier 3.x plus xml and pug plugins
- Package manager: npm, lockfile present

## Toolchain

- Format: self-hosted prettier, trimmer
- Lint: eslint 10.x
- Test: node --test
- Audit: npm audit
